...
namespace Restorunt.Controllers
{
    public class ProductCustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,CustomerId,Quantity,DateFrom,DateTo")] ProductCustomer productCustomer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,ProductId,CustomerId,Quantity,DateFrom,DateTo")] ProductCustomer productCustomer)
        {
